...
<div class="form_connexion">
    ...
    <div class="sousmenu">
        <div class="sousmenu_login select"><a href="./login">Connexion</a></div>
        <div class="sousmenu_register"><a href="register">Inscription</a></div>
    </div>
    ...
    <div class="login">
        ...
        ?>
        <form action="/app/HTML/connexion.php" method="post">
